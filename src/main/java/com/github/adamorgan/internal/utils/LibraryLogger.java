...
/**
 * This class serves as a LoggerFactory for {@link Library} internals.
...
public class LibraryLogger
{
     ...
     * <p>{@value}
     */
    public static final String DISABLE_FALLBACK_PROPERTY_NAME = "com.github.adamorgan.disableFallbackLogger";

    /**
     * Whether an implementation of {@link SLF4JServiceProvider} was found.
     * <br>If false, {@link Library} will use its fallback logger.
     *
    ...
    static
    {
        ...
        try
        {
            ...
            Class<?> fallbackLoggerClass = FallbackLogger.class;
